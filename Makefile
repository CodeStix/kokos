...
build: src/x86_64/** src/common/** src/include/**
	...
	gcc -c -I src/include -masm=intel -ffreestanding -fno-stack-protector src/common/console.c -o build/common/console.o
	gcc -c -I src/include -masm=intel -ffreestanding -fno-stack-protector src/common/acpi.c -o build/common/acpi.o
	gcc -c -I src/include -masm=intel -ffreestanding -fno-stack-protector src/common/pci.c -o build/common/pci.o
	gcc -c -I src/include -masm=intel -ffreestanding -fno-stack-protector src/common/memory.c -o build/common/memory.o
	gcc -c -I src/include -masm=intel -ffreestanding -fno-stack-protector src/common/util.c -o build/common/util.o
	gcc -c -I src/include -masm=intel -ffreestanding -fno-stack-protector src/common/keyboard.c -o build/common/keyboard.o
	gcc -c -I src/include -masm=intel -ffreestanding -fno-stack-protector src/common/apic.c -o build/common/apic.o
	gcc -c -I src/include -masm=intel -ffreestanding -fno-stack-protector src/common/paging.c -o build/common/paging.o
	...
	gcc -c -I src/include -masm=intel -ffreestanding -fno-stack-protector src/common/interrupt.c -o build/common/interrupt.o
